...
indices = [1:30:120  381:30:500]

[ref_frames,ref_descriptors,ref_labels] = get_reference_features({'all'},indices);
...
for i=1:length(num_correct_per_object)
    ...
    num_correct_per_object(i) = find(cur_label_diff == 0);
end


plot(1:num_object,num_correct_per_object,'r.','MarkerSize',10);
