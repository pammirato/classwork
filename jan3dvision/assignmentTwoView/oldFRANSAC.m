function [F,inliers]=oldFRANSAC(matchedPoints1, matchedPoints2,probSol,threshold)
%
...
% 
    ...
    %2) Compute	a solution from the minimal samples	
        ...
        test_left = helper(test_points2',test_points1');
        
        unrolled_F = reshape(F',9,1);
        
       
        test_results = unrolled_F' * test_left';
